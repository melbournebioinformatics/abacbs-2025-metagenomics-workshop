...
```{r load_data}
data_int <- readRDS('Franzosa_IBD_2019.RDS')
...
```{r fig.cap = "Component 1"}
plotDiablo(final.diablo.model, ncomp = 1)
```

```{r fig.cap = "Component 2"}
