...
For an overview, check out the link [here](https://www.metwarebio.com/gsea-enrichment-analysis-guide/).
...
```{r, warning=FALSE, message=FALSE, fig.align='center', fig.dim=c(10, 5)}
library(ggplot2)
library(gridExtra)
library(reshape)
